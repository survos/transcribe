...
class ProjectTimelineController extends AbstractController
{
    ...
    public function index()
    {
        ...
        return $this->render('project/list-projects.html.twig', [
            'projects' => $projects
        ]);
    }
    ...
    public function show(Request $request, Project $project)
    {
        ...
        return $this->render('project/select-markers.html.twig', [
            'project' => $project,
            'markers' => $markers,
